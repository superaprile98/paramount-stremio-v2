...
cd /home/ubuntu/server-stack/paramount-stremio # se hai già clonato qui
sudo bash scripts/deploy-docker.sh
```

> Se non hai ancora clonato il repo sulla VM: `sudo git clone https://github.com/superaprile98/paramount-stremio-v2.git /home/ubuntu/server-stack/paramount-stremio && cd /home/ubuntu/server-stack/paramount-stremio`.
...
4. Clona/aggiorna il repo in `/home/ubuntu/server-stack/paramount-stremio`
...
| Modificare env | `sudo nano /home/ubuntu/server-stack/paramount-stremio/.env && sudo bash scripts/update-docker.sh` |
...
Hai dimenticato di impostare `BASE_URL` nel `.env`. Modifica `/home/ubuntu/server-stack/paramount-stremio/.env`:
...
2. Ricostruisci Paramount: `cd /home/ubuntu/server-stack/paramount-stremio && sudo docker compose up -d --build`
...
Poi aggiorna `BASE_URL=https://addon.example.com` in `/home/ubuntu/server-stack/paramount-stremio/.env` e apri la porta 80+443 invece della 7850 nella Security List.
